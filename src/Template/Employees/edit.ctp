...
<fieldset>
    <legend><?= __('Edit {0}', ['Employee']) ?></legend>
    <?php
           ...
           // echo $this->Form->input('finish_date');
            ...
            echo 'Finish Employee';
            echo '</button>';
            echo '<br/>';
            
            echo '<div class="collapse" id="collapseExample">';
            echo '<br/>';
            echo '<div class="panel panel-primary"><div class="panel-heading">Settings</div><div class="panel-body">';
           ...
           // echo $this->Form->input('created');
            //echo "";
           //echo $this->Form->input('created', ['type' => 'date', 'class' => 'datepicker']); 
            
           // echo $this->Form->input('modified');
            //echo "";
            //echo $this->Form->input('modified', ['type' => 'date', 'class' => 'datepicker']); 
